...
for train_index, test_index in CV.split(X,y):
    ...
    if k == K-1:
        ...
        legend(['Train error','Validation/test error'])
        grid()
...
#%% 8.1.2 - regularization/lambda, train, L2 norm
...
print('High lambda -> high error rate') 
print('Small traning set -> high test error')
